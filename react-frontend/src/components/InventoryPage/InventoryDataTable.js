...
<Column field="itemId" header="Itemid" body={pTemplate0} sortable style={{ minWidth: "8rem" }} />
<Column field="itemName" header="Itemname" body={pTemplate1} sortable style={{ minWidth: "8rem" }} />
<Column field="category" header="Category" body={pTemplate2} sortable style={{ minWidth: "8rem" }} />
<Column field="unitOfMeasure" header="Unitofmeasure" body={pTemplate3} sortable style={{ minWidth: "8rem" }} />
<Column field="quantityOnHand" header="Quantityonhand" body={pTemplate4} sortable style={{ minWidth: "8rem" }} />
<Column field="minimumStockLevel" header="Minimumstocklevel" body={pTemplate5} sortable style={{ minWidth: "8rem" }} />
<Column field="maximumStockLevel" header="Maximumstocklevel" body={pTemplate6} sortable style={{ minWidth: "8rem" }} />
<Column field="reorderPoint" header="Reorderpoint" body={pTemplate7} sortable style={{ minWidth: "8rem" }} />
<Column field="supplier" header="Supplier" body={pTemplate8} sortable style={{ minWidth: "8rem" }} />
