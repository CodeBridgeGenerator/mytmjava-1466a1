...
const WorkOrdersDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    const dt = useRef(null);
    const urlParams = useParams();
    const [showUpload, setShowUpload] =useState(false)

const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.requestid}</p>
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.assignedtouserid}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.startdate}</p>
...
<Column field="requestid" header="Requestid" body={pTemplate0} sortable style={{ minWidth: "8rem" }} />
<Column field="assignedtouserid" header="Assignedtouserid" body={pTemplate1} sortable style={{ minWidth: "8rem" }} />
<Column field="startdate" header="Startdate" body={pTemplate2} sortable style={{ minWidth: "8rem" }} />
<Column field="enddate" header="Enddate" body={pTemplate3} sortable style={{ minWidth: "8rem" }} />
<Column field="status" header="Status" body={pTemplate4} sortable style={{ minWidth: "8rem" }} />
<Column field="notes" header="Notes" body={pTemplate5} sortable style={{ minWidth: "8rem" }} />
