...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Startdate</label><p className="m-0 ml-3" >{_entity?.startdate}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Enddate</label><p className="m-0 ml-3" >{_entity?.enddate}</p></div>
