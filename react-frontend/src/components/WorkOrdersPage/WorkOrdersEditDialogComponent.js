...
notes: _entity?.notes,
        ...
        const result = await client.service("workOrders").patch(_entity._id, _data);
        props.onHide();
    ...
    return (
        <Dialog header="Edit Work Orders" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="workOrders-edit-dialog-component">
