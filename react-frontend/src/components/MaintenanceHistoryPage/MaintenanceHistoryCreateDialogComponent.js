...
performedByUserid: _entity?.performedByUserid,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info maintenanceHistory created successfully" });
    ...
    return (
        <Dialog header="Create Maintenance History" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="maintenanceHistory-create-dialog-component">
...
<div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
                <label htmlFor="datePerformed">Dateperformed:</label>
                <InputText id="datePerformed" className="w-full mb-3 p-inputtext-sm" value={_entity?.datePerformed} onChange={(e) => setValByKey("datePerformed", e.target.value)}  />
            </span>
            </div>
<div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
                <label htmlFor="performedByUserid">Performedbyuserid:</label>
                <InputText id="performedByUserid" className="w-full mb-3 p-inputtext-sm" value={_entity?.performedByUserid} onChange={(e) => setValByKey("performedByUserid", e.target.value)}  />
            </span>
            </div>
