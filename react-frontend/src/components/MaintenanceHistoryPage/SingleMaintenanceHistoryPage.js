...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Dateperformed</label><p className="m-0 ml-3" >{_entity?.datePerformed}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Performedbyuserid</label><p className="m-0 ml-3" >{_entity?.performedByUserid}</p></div>
