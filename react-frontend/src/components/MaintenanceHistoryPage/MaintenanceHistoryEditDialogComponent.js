...
performedByUserid: _entity?.performedByUserid,
    ...
    return (
        <Dialog header="Edit Maintenance History" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="maintenanceHistory-edit-dialog-component">
