...
const MaintenanceHistoryDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    const dt = useRef(null);
    const urlParams = useParams();
    const [showUpload, setShowUpload] =useState(false)

const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.buildingId}</p>
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.requestId}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.description}</p>
const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.datePerformed}</p>
const pTemplate4 = (rowData, { rowIndex }) => <p >{rowData.performedByUserid}</p>
...
<Column field="requestId" header="Requestid" body={pTemplate1} sortable style={{ minWidth: "8rem" }} />
<Column field="description" header="Description" body={pTemplate2} sortable style={{ minWidth: "8rem" }} />
<Column field="datePerformed" header="Dateperformed" body={pTemplate3} sortable style={{ minWidth: "8rem" }} />
<Column field="performedByUserid" header="Performedbyuserid" body={pTemplate4} sortable style={{ minWidth: "8rem" }} />
