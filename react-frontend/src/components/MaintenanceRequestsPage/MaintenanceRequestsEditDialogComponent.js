...
completeddate: _entity?.completeddate,
        ...
        const result = await client.service("maintenanceRequests").patch(_entity._id, _data);
        props.onHide();
    ...
    return (
        <Dialog header="Edit Maintenance Requests" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="maintenanceRequests-edit-dialog-component">
