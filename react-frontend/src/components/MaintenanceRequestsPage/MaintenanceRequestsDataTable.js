...
const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.priority}</p>
const pTemplate4 = (rowData, { rowIndex }) => <p >{rowData.status}</p>
const pTemplate5 = (rowData, { rowIndex }) => <p >{rowData.reporteddate}</p>
const pTemplate6 = (rowData, { rowIndex }) => <p >{rowData.completeddate}</p>
...
<Column field="buildingid" header="Buildingid" body={pTemplate0} sortable style={{ minWidth: "8rem" }} />
<Column field="description" header="Description" body={pTemplate1} sortable style={{ minWidth: "8rem" }} />
<Column field="category" header="Category" body={pTemplate2} sortable style={{ minWidth: "8rem" }} />
<Column field="priority" header="Priority" body={pTemplate3} sortable style={{ minWidth: "8rem" }} />
<Column field="status" header="Status" body={pTemplate4} sortable style={{ minWidth: "8rem" }} />
<Column field="reporteddate" header="Reporteddate" body={pTemplate5} sortable style={{ minWidth: "8rem" }} />
<Column field="completeddate" header="Completeddate" body={pTemplate6} sortable style={{ minWidth: "8rem" }} />
