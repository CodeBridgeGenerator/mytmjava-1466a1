...
const BuildingsDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
...
<Column field="buildingName" header="Buildingname" body={pTemplate0} sortable style={{ minWidth: "8rem" }} />
<Column field="address" header="Address" body={pTemplate1} sortable style={{ minWidth: "8rem" }} />
<Column field="buidlingType" header="Buidlingtype" body={pTemplate2} sortable style={{ minWidth: "8rem" }} />
